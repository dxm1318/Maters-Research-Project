...
function flat_results = organize_results_a(results)
    ...
    for j = 1:size(results, 2)
        ...
        if ~isempty(results(i,j).alpha)
            ...
            tempTable = table(...
                ...
                'VariableNames', {'alpha', 'DP_Type', 'SNR_SL', 'Latency_ms', 'Overlap_%'});          
...
% Save to CSV
writetable(flatResults, 'alpha_sim_Results.csv');
